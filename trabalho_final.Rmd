...
Diante do destaque de regiões mais populosas em relação ao volume de bolsas, consideramos relevante observar os valores também entre beneficiários originários de capitais comparado aos demais municípios, contudo, observa-se que prevalecem largamente os segundos:
...
ufs_pop <- na.omit(pop)
ufs_pop <- left_join(ufs_pop, ufs, by="UF")
